...
$HCSET['FILTER_GEO_LIST'] = 'CZ, SK'; // string([2Chars country codes])
...
$HCSET['FILTER_UTM_LIST'] = 'gclid, utm_term, up2, utm_source'; // 'regExp()';
...
$HCSET['API_SECRET_KEY'] = 'v15d61357ba49f475999292f444a3a5af3';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v25458213&js=false&stage='.$HCSET['stage'];
