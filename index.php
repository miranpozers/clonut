...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 4736;
        $headers['auth']['clientCompany'] = "KKj0P97W8otiOXvXqIp3";
        $headers['auth']['clientSecret'] = "NDczNktLajBQOTdXOG90aU9YdlhxSXAzY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
